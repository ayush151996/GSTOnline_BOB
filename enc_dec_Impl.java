...
System.out.println("inside encrypt");
       ...
       Signature privateSignature = Signature.getInstance(InitiateTransaction_API.ENCRYPTION_ALGO);
...
//  -----------------------------buildPrivateKey Method--------------------------------
   ...
   public static PrivateKey buildPrivateKey(String privateKeySerialized) {
	   //Added new 
 	  System.out.println("Inside buildprivatekey");
...
//           System.out.println(pemReader.read());
//           System.out.println("2.1");
//           System.out.println(pemReader.readObject());
//           KeyPair keyPair = (KeyPair) pemReader.readObject();
//           System.out.println("3");
//           pKey = keyPair.getPrivate();//keypair null error
